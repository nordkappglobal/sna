...
const content = {
  vi: {
    ...
    footerDemo: "Lịch học, học phí và một số thông tin chương trình sẽ được cập nhật theo xác nhận chính thức của các đơn vị phối hợp.", footerNav: "Điều hướng", footerContact: "Thông tin liên hệ", backTop: "Về đầu trang ↑",
  ...
  en: {
    ...
    instructorKicker: "Teaching team", instructorTitle: "Professional – Inspiring", instructorIntro: "Our featured instructors and coaches bring strong professional expertise, years of experience and student-appropriate teaching methods.", instructorFootball: "Football", instructorDance: "Modern dance", instructorKarate: "Karate", instructorBasketball: "Basketball", instructorTaekwondo: "Taekwondo", coach1Role: "Coach · 6 years of experience", coach1Credential: "AFC Coaching Certificate", coach2Role: "Instructor · 9 years of experience", coach2Credential: "Bachelor of Dance Coaching", coach3Role: "Coach · 10 years of experience", coach3Credential: "Karate 4th Dan black belt", coach4Role: "Coach · 10 years of experience", coach4Credential: "Bachelor of Sports Coaching", coach5Role: "Instructor · 15 years of experience", coach5Credential: "Master of Education",
    ...
    footerDemo: "Schedules, fees and selected program details will be updated after official confirmation from the organizing partners.", footerNav: "Navigation", footerContact: "Contact information", backTop: "Back to top ↑",
