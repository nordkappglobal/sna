...
const content = {
  vi: {
    ...
    primaryCta: "Đăng ký nhận tư vấn", secondaryCta: "Khám phá 8 môn học", trustActivities: "bộ môn đa dạng", trustGroups: "nhóm phát triển", trustSaving: "tiết kiệm trọn khóa", imageDemo: "Minh họa AI — không phải ảnh học sinh hoặc cơ sở thực tế của SNA", imageDemoShort: "Minh họa AI",
    ...
    facilityKicker: "Không gian định hướng", facilityTitle: "Một môi trường hiện đại, an toàn và giàu cảm hứng", facilityNote: "Các hình dưới đây là minh họa AI dựa trên ngôn ngữ không gian của SNA, không mô tả chính xác cơ sở thực tế.", facility1: "Sân thể thao đa năng", facility2: "Phòng nghệ thuật linh hoạt", facility3: "Khu vực đón trả an toàn",
    ...
    courseAge: "Độ tuổi mẫu", courseTime: "Lịch mẫu", coursePrice: "Học phí/HS/buổi", courseInterest: "Tôi quan tâm", courseDemo: "MINH HỌA AI", categorySports: "Thể thao", categoryMartial: "Võ thuật", categoryArts: "Nghệ thuật — biểu diễn"
  },
  en: {
    ...
    primaryCta: "Request a consultation", secondaryCta: "Explore 8 activities", trustActivities: "diverse activities", trustGroups: "development paths", trustSaving: "full-course saving", imageDemo: "AI illustration — not an actual SNA student or facility photograph", imageDemoShort: "AI illustration",
    ...
    facilityKicker: "Spatial direction", facilityTitle: "A modern, safe and inspiring environment", facilityNote: "These AI illustrations draw on SNA's spatial language and do not depict the actual campus precisely.", facility1: "Multi-sport grounds", facility2: "Flexible arts studio", facility3: "Safe pickup zone",
    ...
    courseAge: "Sample age", courseTime: "Sample schedule", coursePrice: "Fee/student/session", courseInterest: "I'm interested", courseDemo: "AI ILLUSTRATION", categorySports: "Sports", categoryMartial: "Martial arts", categoryArts: "Performing arts"
  }
};

const courses = [
  { id: "football", group: "sports", vi: "Bóng đá", en: "Football", price: "189.000 ₫", ageVi: "6–12 tuổi", ageEn: "Ages 6–12", timeVi: "T3 & T5 · 16:30", timeEn: "Tue & Thu · 4:30 PM", image: "/assets/generated/courses/football-v1.webp" },
  { id: "basketball", group: "sports", vi: "Bóng rổ", en: "Basketball", price: "189.000 ₫", ageVi: "7–14 tuổi", ageEn: "Ages 7–14", timeVi: "T2 & T6 · 16:30", timeEn: "Mon & Fri · 4:30 PM", image: "/assets/generated/courses/basketball-v1.webp" },
  { id: "dance", group: "arts", vi: "Dance — Nhảy hiện đại", en: "Modern Dance", price: "189.000 ₫", ageVi: "6–15 tuổi", ageEn: "Ages 6–15", timeVi: "T4 & T7 · 16:30", timeEn: "Wed & Sat · 4:30 PM", image: "/assets/generated/courses/modern-dance-v1.webp" },
  ...
  { id: "taekwondo", group: "martial", vi: "Taekwondo", en: "Taekwondo", price: "189.000 ₫", ageVi: "6–15 tuổi", ageEn: "Ages 6–15", timeVi: "Đang xếp lịch mẫu", timeEn: "Sample schedule pending", image: "/assets/generated/courses/taekwondo-v1.webp" },
  { id: "karate", group: "martial", vi: "Karate", en: "Karate", price: "189.000 ₫", ageVi: "7–15 tuổi", ageEn: "Ages 7–15", timeVi: "Đang xếp lịch mẫu", timeEn: "Sample schedule pending", image: "/assets/generated/courses/karate-v1.webp" },
