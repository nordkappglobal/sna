...
const content = {
  vi: {
    ...
    heroEyebrow: "SNA CCA PROGRAM · 2026-2027", heroTitle: "Khơi mở năng khiếu.<br>Rèn luyện bản lĩnh.<br><span>Phát triển toàn diện.</span>", heroDescription: "Chương trình thể thao, võ thuật và nghệ thuật dành cho học sinh tổ chức tại SNA với đội ngũ chuyên nghiệp.",
    primaryCta: "Đăng ký nhận tư vấn", secondaryCta: "Khám phá 8 môn học", trustActivities: "hoạt động ngoại khóa", trustGroups: "lĩnh vực phát triển", trustSaving: "ưu đãi trọn khóa",
    proofKicker: "ĐIỀU PHỤ HUYNH QUAN TÂM", proofTitle: "Môi trường hoạt động ngoại khóa an toàn, chuyên nghiệp", proof1: "An toàn trong suốt buổi học", proof2: "Môn học phù hợp với sở thích và độ tuổi", proof3: "Học phí và thông tin minh bạch", proofDemo: "Quy trình chi tiết sẽ được cập nhật trước ngày khai giảng.",
  ...
  en: {
    ...
    heroEyebrow: "SNA CCA PROGRAM · 2026-2027", heroTitle: "Unlock potential.<br>Build confidence.<br><span>Grow holistically.</span>", heroDescription: "A sports, martial arts and performing arts program for students, hosted at SNA and delivered by a professional team.",
    primaryCta: "Request a consultation", secondaryCta: "Explore 8 activities", trustActivities: "co-curricular activities", trustGroups: "development areas", trustSaving: "full-course saving",
    proofKicker: "WHAT PARENTS CARE ABOUT", proofTitle: "A safe, professional CCA environment", proof1: "Safety throughout every session", proof2: "Activities suited to each child's interests and age", proof3: "Transparent fees and information", proofDemo: "Detailed procedures will be updated before classes begin.",
...
function applyLanguage(lang) {
  ...
  document.title = lang === "vi" ? "SNA CCA | Chương trình Hoạt động Ngoại khóa" : "SNA CCA | Co-Curricular Activities";
