...
const content = {
  vi: {
    skip: "Bỏ qua đến nội dung chính", demoBadge: "THÔNG TIN ĐANG CẬP NHẬT", demoNote: "Lịch học, học phí và hồ sơ giảng viên sẽ được cập nhật sau khi có xác nhận chính thức.", openMenu: "Mở menu", partnerLabel: "Phối hợp triển khai",
    ...
    instructorKicker: "Đội ngũ giảng dạy", instructorTitle: "Chuyên nghiệp – Đầy cảm hứng", instructorIntro: "Đội ngũ giảng viên và huấn luyện viên có chuyên môn, kinh nghiệm và phương pháp hướng dẫn phù hợp với học sinh. Hồ sơ chi tiết sẽ được cập nhật sau khi danh sách chính thức được xác nhận.", profileDemo: "Đang cập nhật hồ sơ", coach1: "Huấn luyện viên thể thao", coach1Role: "Thông tin chi tiết đang được cập nhật", coach2: "Huấn luyện viên võ thuật", coach2Role: "Thông tin chi tiết đang được cập nhật", coach3: "Giảng viên nghệ thuật", coach3Role: "Thông tin chi tiết đang được cập nhật",
  ...
  en: {
    skip: "Skip to main content", demoBadge: "INFORMATION BEING UPDATED", demoNote: "Schedules, fees and instructor profiles will be updated after official confirmation.", openMenu: "Open menu", partnerLabel: "In collaboration with",
    ...
    instructorKicker: "Teaching team", instructorTitle: "Professional – Inspiring", instructorIntro: "Our instructors and coaches bring the expertise, experience and teaching approach needed to support students. Detailed profiles will be added after the official team is confirmed.", profileDemo: "Profile being updated", coach1: "Sports coach", coach1Role: "Details are being updated", coach2: "Martial arts coach", coach2Role: "Details are being updated", coach3: "Arts instructor", coach3Role: "Details are being updated",
...
const faqs = {
  vi: [
    ...
    ["Bao lâu sau khi đăng ký tôi sẽ được liên hệ?", "Form trực tuyến đang được hoàn thiện. Trong thời gian này, phụ huynh vui lòng liên hệ hotline để được hỗ trợ trực tiếp."]
  ],
  en: [
    ...
    ["How soon will I be contacted after registration?", "The online form is being finalized. Please contact the hotlines for direct assistance in the meantime."]
  ]
};
